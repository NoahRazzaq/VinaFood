        ...
        <form method="post" action="{{route('product.update', $product->id)}}">
            ...
            <div class="mb-6">
              ...
              <div class="mb-6">
                ...
                <input type="text" id="price" name="price" value="{{old('price') ?  old('price') : $product->price}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="">
              </div>
                ...
                <select name="restaurant" class="form-select">
                    ...
                    @foreach($restaurants as $restaurant)
                        <option value="{{ $restaurant->id }}" 
                            @if(old('restaurant') == $restaurant->id || $product->restaurant_id == $restaurant->id) 
                                selected 
                            @endif
                        >
                            {{ $restaurant->name }}
