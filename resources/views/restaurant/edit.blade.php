<x-app-layout>
    ...
    <form method="POST" action="{{ route('restaurant.update', $restaurant->id) }}" class="space-y-10 w-full max-w-md">
        @csrf
        @method('put')
        <div class="mb-6">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Nom</label>
            <input type="text" id="name" name="name"
                value="{{ old('name') ? old('name') : $restaurant->name }}"
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500
                placeholder="sandwich poulet">
            @error('name')
            <div class="flex items-center p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:text-red-400" role="alert">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="phone" value="{{ old('phone') ? old('phone') : $restaurant->phone }}"
                name="phone"
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="sandwich poulet">
            @error('phone')
        ...
        <div class="mb-6">
            ...
            <input type="text" id="address" value="{{ old('address') ? old('address') : $restaurant->address }}"
                name="address"
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="">
            @error('address')
        ...
        <div class="mb-6">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Code
                postal</label>
            <input type="text" id="cp" name="cp" value="{{ old('cp') ? old('cp') : $restaurant->cp }}"
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="">
            @error('cp')
            <div class="flex items-center p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:text-red-400" role="alert">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="city" name="city"
                value="{{ old('city') ? old('city') : $restaurant->city }}"
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="">
            @error('city')
            <div class="flex items-center p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:text-red-400" role="alert">
